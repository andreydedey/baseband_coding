...
def plot_hdb3():
    ...
    plot_signal(SEQUENCE_1, signal_1, "HDB3 Encoded Sequence", os.path.join(outpur_dir, "hdb3_encoded_signal1"))

    # Gráfico do sinal 2 HDB3 codificado
    plot_signal(SEQUENCE_2, signal_2, "HDB3 Encoded Sequence", os.path.join(outpur_dir, "hdb3_encoded_signal2"))
